...
;(function ($) {
  ...
  function setupEnhancedAriaLabeling() {
      ...
      if (classList) {
        ...
        if (socialName) {
          ...
          const ariaLabel = wp.i18n.sprintf(
            wp.i18n.__('Visit our %s page', 'wp-plugin-boilerplate'),
            socialName
          )
    ...
    $("a.et-pb-arrow-prev").each(function(){
      $(this).attr({
        "aria-label": wp.i18n.__('Previous slide', 'wp-plugin-boilerplate'),
        "role": "button"
      })
    })
    ...
    $("a.et-pb-arrow-next").each(function(){
      $(this).attr({
        "aria-label": wp.i18n.__('Next slide', 'wp-plugin-boilerplate'), 
        "role": "button"
      })
    })

    // Swiper Controls
    $(".swiper-button-prev").attr("aria-label", wp.i18n.__('Previous slide', 'wp-plugin-boilerplate'))
    $(".swiper-button-next").attr("aria-label", wp.i18n.__('Next slide', 'wp-plugin-boilerplate'))

    // Video Play Buttons
    $("a.et_pb_video_play").each(function(){
      $(this).attr("aria-label", wp.i18n.__('Play video', 'wp-plugin-boilerplate'))
    })
  }
