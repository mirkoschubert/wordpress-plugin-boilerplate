...
class Downloads
{
  ...
  public function download_fonts($font_families)
  {
    ...
    update_option('wp_plugin_boilerplate_installed_fonts', $installed_fonts);
  }
  ...
  {
    $metadata = get_transient('wp_plugin_boilerplate_gwfh_fonts_metadata');
  ...
  private function track_font_files($font_family, $files)
  {
    ...
    update_option('wp_plugin_boilerplate_font_files', $tracked_files);
  }
