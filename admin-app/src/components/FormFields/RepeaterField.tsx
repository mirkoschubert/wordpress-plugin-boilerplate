...
const RepeaterField = forwardRef<HTMLDivElement, RepeaterFieldProps>(({
  ...
  const getItemPreview = (item: Record<string, unknown>): string => {
    ...
    return __('Empty item', 'wp-plugin-boilerplate')
  }
      ...
      <div className="repeater-items">
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="item-label">
                        {preview || __('Empty item', 'wp-plugin-boilerplate')}
                      </span>
                    </Button>
                  </FlexItem>
                  <FlexItem>
                    <Button
                      ...
                      size="small"
                    >
                      {__('Remove', 'wp-plugin-boilerplate')}
                    </Button>
                  </FlexItem>
                </Flex>
              </CardHeader>
        ...
        {value.length === 0 && (
          <div className="repeater-empty">
            <p>{__('No items yet. Add your first item below.', 'wp-plugin-boilerplate')}</p>
          </div>
        )}
      </div>
        ...
        >
          {__('Add Item', 'wp-plugin-boilerplate')}
        </Button>
      </div>
    </div>
  )
