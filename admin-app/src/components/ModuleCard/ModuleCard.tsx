        ...
        <div className="module-content">
          <div className="module-info">
            <dl className="module-details">
              <dt>{__('Version', 'wp-plugin-boilerplate')}</dt>
              <dd>{module.version}</dd>

              <dt>{__('Author', 'wp-plugin-boilerplate')}</dt>
              <dd>{module.author}</dd>

              {/* <dt>{__('Requires Divi Version', 'wp-plugin-boilerplate')}</dt>
      ...
      <CardFooter>
        {Object.keys(module.admin_settings).length > 0 && (
          <Button
            ...
            variant="secondary"
          >
            {__('Settings', 'wp-plugin-boilerplate')}
          </Button>
        )}
      </CardFooter>
    </Card>
