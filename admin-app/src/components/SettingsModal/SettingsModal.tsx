...
const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <Modal
      title={`${module.name} ${__('Settings', 'wp-plugin-boilerplate')}`}
    ...
    >
      {isLoading ? (
        <div className="dvc-loading">
          <Spinner />
          <p>{__('Loading settings...', 'wp-plugin-boilerplate')}</p>
        </div>
      ) : (
        <>
          ...
          <div className="dvc-modal-footer">
            <Button
              ...
              disabled={isSaving}
            >
              {__('Cancel', 'wp-plugin-boilerplate')}
            </Button>
            ...
            >
              {isSaving
                ? __('Saving...', 'wp-plugin-boilerplate')
                : __('Save Settings', 'wp-plugin-boilerplate')
              }
            </Button>
          </div>
        </>
